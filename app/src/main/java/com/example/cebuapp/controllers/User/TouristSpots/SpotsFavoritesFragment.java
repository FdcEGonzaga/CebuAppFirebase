...
public class SpotsFavoritesFragment extends Fragment {
    ...
    // online recyclerview
    private SpotsFavoritesRVAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_spots_favorites, container, false);
        castComponents();
        setListeners();
        ...
        adapter = new SpotsFavoritesRVAdapter(getActivity());
