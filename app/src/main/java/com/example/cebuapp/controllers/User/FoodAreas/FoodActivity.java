...
public class FoodActivity extends AppCompatActivity {
    ...
    public void onStart() {
        ...
        dialog.setTitle("Getting the latest food areas for you...");
        dialog.show();
    }
    ...
    private void onlineProvinceSpinner() {
        ...
        provinceSpinnerAdapter = new ArrayAdapter<String>(FoodActivity.this, android.R.layout.simple_spinner_dropdown_item,
                provinceSpinnerList);
        ...
        provinceSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                dialog.setTitle("Fetching " + selectedCategory + "'s food areas.");
                dialog.show();
                    ...
                    public void run() {
                        if (isConnectedToInternet()) {
                            ...
                            if (selectedCategory.equals("ALL")) {
                                getAllOnlineFoodAreas();
                            } else {
                                getAllOnlineDataByProvince(selectedCategory);
                            }
                        } else {
    ...
    private void getAllOnlineFoodAreas() {
        crudFoodAreas.getAllApproved(true).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ArrayList<FoodArea> foodList = new ArrayList<>();
                for (DataSnapshot data : snapshot.getChildren()) {
                    FoodArea dataFoodAreas = data.getValue(FoodArea.class);

                    // set data
                    dataFoodAreas.setKey(data.getKey());

                    // append to list
                    foodList.add(dataFoodAreas);
                    key = data.getKey();
                }
    ...
    private void getAllOnlineDataByProvince(String provinceName) {
        crudFoodAreas.getByProvince(provinceName).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ArrayList<FoodArea> foodList = new ArrayList<>();
                for (DataSnapshot data : snapshot.getChildren()) {
