...
public class JobPostsFavoritesFragment extends Fragment {
    ...
    // online recyclerview
    private JobPostsFavoritesRVAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_job_posts_favorites, container, false);
        castComponents();
        setListeners();
        ...
        adapter = new JobPostsFavoritesRVAdapter(getActivity());
    ...
    private void getFavorites() {
        ...
        crudFavorites.getAllFavorites(customPath, postCategory).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ArrayList<FavoriteJobs> favList = new ArrayList<>();
                for (DataSnapshot data : snapshot.getChildren()) {
                    FavoriteJobs favData = data.getValue(FavoriteJobs.class);
