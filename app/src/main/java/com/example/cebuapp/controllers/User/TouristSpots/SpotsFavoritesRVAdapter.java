...
public class SpotsFavoritesRVAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private SpotsRVAdapter spotsRVAdapter;

    ArrayList<Favorites> list = new ArrayList<>();

    public SpotsFavoritesRVAdapter(Context ctx) {
        this.context = ctx;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SpotsFavoritesRVAdapter.FavoritesVH(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        SpotsFavoritesRVAdapter.FavoritesVH myHolder = (SpotsFavoritesRVAdapter.FavoritesVH) holder;
        ...
        spotsRVAdapter = new SpotsRVAdapter(context);

        // remove to favorites
        myHolder.heart.setOnClickListener(v-> {
            new AlertDialog.Builder(context)
                    .setTitle("CebuApp")
                    .setMessage("Do you really want to remove Tourist Spot title '" + favoriteData.getPostDesc1() + "' from your Favorites?")
                    .setCancelable(false)
